...
class FID_Score:
    def __init__(self, dataset_1, dataset_2, device, crop_size=None, generator=None, mapping=None, batch_size=128, dims=2048, num_workers=0, gpu_devices=[]):
        ...
        inception_model = models.inception_v3(pretrained=False).to(self.device)
        state_dict = torch.load('/home2/lxh/New_alg/CG-MI/CG-MI-main/Index_weight/pt_inception-2015-12-05-6726825d.pth')
    ...
    def compute_statistics(self, dataset, rtpt=None):
        ...
        for step, (x, y) in enumerate(dataloader):
            with torch.no_grad():
                if x.shape[1] != 3:
                    x = create_image(x, self.generator, self.mapping,
