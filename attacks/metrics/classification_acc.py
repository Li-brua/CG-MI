...
from attacks.metrics.accuracy import Accuracy, AccuracyTopK
...
class ClassificationAccuracy():
    ...
    def compute_acc(self, w, targets, generator, mapping, config, batch_size=64, resize=299, rtpt=None): #targets [0,1]
        ...
        with torch.no_grad():
            for step, (w_batch, target_batch) in enumerate(DataLoader(dataset,
                ...
                imgs = create_image(
                    w_batch, generator, mapping, config.attack_center_crop, resize=resize, batch_size=batch_size)
