...
from attacks.models.Classifier_ensemble import Classifier_ensemble
from rtpt.rtpt import RTPT
from torchvision.datasets import *

from attacks.datasets.celeba import CelebA1000
from attacks.datasets.custom_subset import Subset
from attacks.datasets.facescrub import FaceScrub
from attacks.datasets.generate_data import GenerateDataset
from attacks.datasets.stanford_dogs import StanfordDogs
from attacks.utils.datasets import get_normalization
...
class TrainingConfigParser:
    ...
    def create_model(self, ensemble=False):
        model_config = self._config['model']
        print(model_config)
        if ensemble:
            model = Classifier_ensemble(**model_config)
        else:
